...
This document describes how to copy and customise the Frame (bootstrapbase) theme so that
...
From your Moodle theme directory right click on frame and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of frame.
...
underscores. For the purpose of this tutorial we will call the theme 'customframe'.

On opening 'customframe' your you will find several files and sub-directories which have
files within them.
...
'frame' to 'customframe'. This includes the filename of the lang/en/theme_frame.php.
You need to change this to 'theme_customframe.php'.
...
and then click on (Customframe) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the Frame theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > Frame
