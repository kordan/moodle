...
$string['customlogourldesc'] = 'Please add your custom logo if you want to replace the default logo for this theme. As a reference the default logo is 200px wide, 50px high and a transparent png will work best.';
...
$string['frontpagelogourldesc'] = 'Please add your custom logo if you want to replace the logo that is displayed on the front page of your site. This logo overrides the custom logo (whether existing).<br />As a reference the default logo is 300px wide, 80px high and a transparent png will work best.';
